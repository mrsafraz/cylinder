...
var ViewModel = function(){
	...
	this.showDialog = function(variant, params){
		...
		// return dialog['show' + variant]('demo/ui/dialogs/hello', params);
		return dialog['show' + variant]('_widgets/lookup-popup/lookup-popup', params);
	}
	...
	this.showAdvancedMessageBox = function(){
		...
		return;
		dialog.showConfirm('Are You Crazy?', 'Self Evaluation', ['Yes', 'No']).then(function(ok){
			this.userIsCrazy(ok);
		}.bind(this));
	}
